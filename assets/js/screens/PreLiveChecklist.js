...
export default function PreLiveChecklist(props) {
  ...
  useEffect(() => {
    ...
    if (toggleCheckBox1 == true && toggleCheckBox2 == true && toggleCheckBox3 == true && toggleCheckBox4 == true && toggleCheckBox5 == true){
      setDisabled(false)
    } else {
      setDisabled(true)
    }
  ...
  }, [toggleCheckBox1, toggleCheckBox2, toggleCheckBox3, toggleCheckBox4, toggleCheckBox5])
    ...
    <SafeAreaView style={{ flex: 0, backgroundColor: colors.bg, paddingTop: Platform.OS === 'android' ? 25 : 0 }}>
      ...
      <View style={{flex: 1, position: "absolute", right: 0, flexDirection: 'row-reverse', paddingRight: 10, marginTop: 10, marginRight: 10, zIndex: 2 }}>
        ...
        <View style={styles.checkBoxesContainer}>
          ...
          />
          <Text style={styles.subHeading}>posted on social media that you’re about to start</Text>
        </View>
