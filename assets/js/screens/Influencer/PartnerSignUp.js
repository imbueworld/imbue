...
export default function PartnerSignUp(props) {
  ...
  return (
    <KeyboardAwareScrollView
      ...
      contentContaineStyle={styles.scrollView}
      ...
      <CustomCapsule style={styles.container}>
        ...
        /> */}
          ...
          <CustomTextInput
            containerStyle={{
              borderColor: redFields.includes('passwordConfirm')
                ? 'red'
                : undefined,
            }}
            multiline={false}
