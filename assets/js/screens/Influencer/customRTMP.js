      ...
      {!user.stream_key ? (
        <>
          <Text style={{ ...FONTS.body, textAlign: 'center', marginTop: 25 }}>
            You must create your first live stream (click go live and start the
            live stream, then end it after about 10 seconds)
          </Text>
          ...
          <CustomButton
            ...
            title="Go Live"
            onPress={() => {
              toggleStream, props.navigation.navigate('GoLive');
            }}
          />
        </>
      ) : (
        <>
          <View>
            <Text
              ...
              Copy and Paste each of these into your prefered brodcasting
              software.
            </Text>
          </View>
          <View>
