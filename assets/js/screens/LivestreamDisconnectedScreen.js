...
export default function LivestreamDisconnectedScreen(props) {
      ...
      await firestore()
        ...
        .then((documentSnapshot) => {
          ...
          setFillerText(
            ...
            } is not live. Try pulling down to refresh...`,
          );
  ...
  const getLiveStatus = async () => {
    ...
    const snapshot = await firestore()
      .collection('partners')
      .where('playback_id', '==', thisPlaybackId)
      .get();
    ...
    switch (docu.data().liveStatus) {
      ...
      case 'video.live_stream.disconnected':
        setFillerText(
          `The livestream has been disconnected. Try refreshing the page. The influencer may have ended the video`,
        );
        break;
      default:
        break;
