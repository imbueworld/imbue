...
export default function Landing(props) {
  ...
  async function sendGridTest() {
    ...
    const sendGridEmailPayoutPaid = functions().httpsCallable(
      'sendGridEmailPayoutPaid',
    );
    ...
    <ScrollView
      ...
      <CustomCapsule
        ...
        <Text
          ...
          someone who loves taking fitness classes
        </Text>
        ...
        <Text
          ...
          someone who loves creating fitness content
        </Text>
      </CustomCapsule>
    </ScrollView>
  );
