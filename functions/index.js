...
/**
 * Adds Individual class to native calendar
 */
exports.addIndividualClassToCalendar = functions.https.onCall(async (data) => {

  const classDoc = data
  
  console.log("RNCalendarEvents.checkPermissions(): ", RNCalendarEvents.checkPermissions())
  ...
  if (formattedTime.length == 17) { //00:00 - 00:00
    ...
    console.log("start_time_formatted: ", start_time_formatted)
